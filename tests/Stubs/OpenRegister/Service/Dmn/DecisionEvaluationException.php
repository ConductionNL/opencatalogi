...
/**
 * CI STUB — functional signature copy of openregister lib/Service/Dmn/DecisionEvaluationException.php
 * at OR development 2839ab901 (2026-09-02), OR-repo @spec tags stripped.
 * Loaded by tests/bootstrap-unit.php only when no sibling openregister
 * checkout is present; signatures MUST track OR development.
 *
