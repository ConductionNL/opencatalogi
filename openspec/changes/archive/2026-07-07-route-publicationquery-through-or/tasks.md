...
- [x] Confirm the OpenRegister cross-schema search entry point is available
...
- [x] Replace the raw `UNION ALL` + `magicTableExists()` `information_schema`
...
- [x] Add a grep guard (or extend the local abstraction lint) asserting no
