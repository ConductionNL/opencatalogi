...
- [ ] Bundle three value lists (informatiecategorieën → TOOI URIs;
...
- [ ] Add a `tooiIdentifier` property to the `organization` schema in
...
- [ ] `SitemapService::mapDiwooDocument()`: resolve `informatiecategorie`,
...
- [ ] Add the "Validate DIWOO output" action: run the mapping in dry-run,
...
- [ ] Newman: assert TOOI category/org/soortHandeling URIs on a fully-mapped
