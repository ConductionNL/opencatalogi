 ...
 *
 * This file is loaded by tests/bootstrap-unit.php when the real interface is absent.
 * It is NOT scanned by PHPCS.
 *
 * @category Test
 * @package  OCA\OpenCatalogi\Tests\Stubs\Mcp
 *
...
if (interface_exists(IMcpToolProvider::class) === false) {
     ...
     * the real interface. OpenCatalogi implements this stub in production; the stub
     * is replaced by the real interface when the openregister app is installed.
     */
    interface IMcpToolProvider
    {
         ...
         *
         * @return string The app slug (e.g. "opencatalogi")
         */
