...
class FakeSchemaMapper {
	 ...
	 * the WOO-572 read-rule guard keeps them in the anonymous scope by default.
	 *
	...
	public function find(int|string $id): object {
		...
		$authorization = array_key_exists((int) $id, $this->authorizationById)
			...
			: ['read' => [['group' => 'public', 'match' => ['publicatiedatum' => ['$lte' => '$now']]]]];
...
class PublicationQueryServiceTest extends TestCase {
	 ...
	 */
	// -------------------------------------------------------------------------
	// WOO-572 review — SCH-PFTS-CAT-002 read-rule guard.
	// -------------------------------------------------------------------------
