...
## Purpose
Provides the theme and glossary modals for managing publication presentation and terminology. The add-publication-theme and view-theme modals offer theme options, list existing themes, and persist a theme, while the glossary view modal displays a selected term and opens it for editing.
