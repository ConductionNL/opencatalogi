 ...
 *
 * This service imports `lib/Settings/opencatalogi_mock_register.json` — a
 * `type: mock` descriptor whose every object was generated from the schema
 * that validates it — through the same OpenRegister importer the app already
 * uses for its real configuration.
 *
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/opencatalogi_mock_register.json';
