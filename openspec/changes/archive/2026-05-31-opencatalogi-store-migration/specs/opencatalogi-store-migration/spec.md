...
### REQ-OSM-1 — Outer store wraps the canonical lib store
...
### REQ-OSM-3 — Public API preservation
...
### REQ-OSM-4 — Local-only modules untouched
...
### REQ-OSM-5 — Plugin override side-effects
...
### REQ-OSM-6 — Cross-schema createObject override
