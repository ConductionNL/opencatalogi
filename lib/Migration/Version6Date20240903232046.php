 ...
 */
class Version6Date20240903232046 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		if($schema->hasTable(tableName: 'publications') === true) {
			...
			if($table->hasColumn(name: 'validation') === false) {
				$table->addColumn(name: 'validation', typeName: Types::JSON)->setDefault('{}');
			}
		}
