			...
			<div class="dialog-content">
				...
				<div v-if="!success">
					...
					<div class="detail-grid">
						<div class="detail-item" :class="{ 'empty-value': !currentCatalogi?.title }">
							<span class="detail-label">Catalogi:</span>
							<span class="detail-value">{{ currentCatalogi?.title || 'Not selected' }}</span>
						</div>
