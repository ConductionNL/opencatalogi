...
class GlossaryControllerTest extends TestCase
{
     ...
     * a plain array (see FLAGGED lib bug GlossaryController::322 — the is_array() guard
     * runs one line too late). Production results are entity objects, so the test feeds
     * a serializable object to exercise the intended path.
     *
