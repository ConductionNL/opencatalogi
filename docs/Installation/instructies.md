...
There are several installation options, we recommend using the publication platform developed by [Acato](acato.nl) in collaboration with [Tilburg](tilburg.nl). This is available as a Docker container via the [Conduction Codeberg](https://codeberg.org/Conduction/-/packages). In the repository itself you will find besides a [docker-compose](https://codeberg.org/Conduction/tilburg-woo-ui/src/branch/softwarecatalogus/docker-compose.yml) also further [installation instructions](https://codeberg.org/Conduction/tilburg-woo-ui/src/branch/softwarecatalogus). 