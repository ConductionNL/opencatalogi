...
webpackConfig.resolve.alias = {
	...
	// `import` condition. @nextcloud/vue's CJS bundle still uses
	// require('@nextcloud/axios') and webpack 5's CommonJS resolver fails
	// the exports check with:
	//   "." is not exported under the conditions ["require","module","webpack",...]
	// Aliasing the bare specifier directly at the dist entry sidesteps
	// the exports-field gate. Use the $-suffixed exact-match form so
	// subpath imports (e.g. @nextcloud/axios/dist/foo) keep their normal
	// resolution.
