...
use OCA\OpenCatalogi\Repair\WOO572RepairReadRules;
 ...
 */
class WOO572RepairReadRulesTest extends TestCase
{
    private IAppManager&MockObject $appManager;
    private ContainerInterface&MockObject $container;
    private LoggerInterface&MockObject $logger;
    private WOO572RepairReadRules $step;
    ...
    protected function setUp(): void
    {
        ...
        $this->step       = new WOO572RepairReadRules(
            $this->appManager,
            $this->container,
            $this->logger
        );
