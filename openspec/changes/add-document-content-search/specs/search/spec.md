...
Documents whose linked publication is invalid (per SCH-PFTS-003 — no linked publication, or a non-public one) MUST be dropped from the content-search result set as well.
